...
def load_data(work_id, firm_name):
    ...
    Returns tuple: (data, work_subcategory)
    """
    all_data = []
    ...
    if work_details:
        # Extract subcategory from work metadata
        work_subcategory = work_details.get('work_type_subcategory')
    ...
    return all_data, work_subcategory
