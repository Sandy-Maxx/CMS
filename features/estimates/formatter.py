...
def format_columns(worksheet, data_start_row, data_end_row, column_headers, summary_start_row=None, summary_end_row=None):
    """
...
def style_work_name_row(worksheet, work_name_row_idx, total_columns):
    """
    Applies specific styling to the work name row: height, bold font, center alignment, optional fill color.
    """
    # Set row height
    ...
    work_name_fill = PatternFill(start_color="FFE6F3FF", end_color="FFE6F3FF", fill_type="solid")
    ...
    for col_idx in range(1, total_columns + 1):
        ...
        cell.fill = work_name_fill

def apply_all_styles_and_formats(worksheet, header_row_idx, data_start_row, data_end_row, summary_start_row, summary_end_row, column_headers, all_data, work_name_row_idx):
    """
    ...
    format_columns(worksheet, data_start_row, data_end_row, column_headers, summary_start_row, summary_end_row)
